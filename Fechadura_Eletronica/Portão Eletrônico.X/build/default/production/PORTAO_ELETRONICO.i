...
# 2 "<built-in>" 2
# 1 "PORTAO_ELETRONICO.c" 2
# 18 "PORTAO_ELETRONICO.c"
...
# 32 "PORTAO_ELETRONICO.c" 2

# 1 "./teclado.h" 1
# 29 "./teclado.h"
unsigned char tc_tecla(unsigned int timeout);
# 33 "PORTAO_ELETRONICO.c" 2
